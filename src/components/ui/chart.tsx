  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          "[&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-border/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-border [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-border [&_.recharts-radial-bar-background-sector]:fill-muted [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-muted [&_.recharts-reference-line_[stroke='#ccc']]:stroke-border flex aspect-video min-h-[200px] justify-center text-xs [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-hidden [&_.recharts-sector]:outline-hidden [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-surface]:outline-hidden",
          className
        )}
        {...props}
      >
...
const ChartTooltip = React.forwardRef<any, any>((props, ref) => {
  ...
  React.useEffect(() => {
    import("recharts").then((mod) => setTooltip(() => mod.Tooltip))
  }, [])
...
const ChartLegend = React.forwardRef<any, any>((props, ref) => {
  ...
  React.useEffect(() => {
    import("recharts").then((mod) => setLegend(() => mod.Legend))
  }, [])
