    ...
    ? [
        {
          ...
          fill: USER_CHART_COLORS[0],
        },
        {
          name: "Teachers",
          value: data.users.teachers,
          fill: USER_CHART_COLORS[1],
        },
        {
          name: "Parents",
          value: data.users.parents,
          fill: USER_CHART_COLORS[2],
        },
        {
          name: "Admins",
          value: data.users.admins,
          fill: USER_CHART_COLORS[3],
        },
      ]
    : [];
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-2 mt-4">
                  {userDistributionData.map((item) => (
                    <div
                      key={item.name}
                      className="text-center p-2 rounded-lg bg-gray-50 dark:bg-gray-900"
                    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Ranked by active subscription revenue
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
                  ...
                  {data?.planDistribution.map((entry) => (
                    ...
                    >
                      <div
                        className="h-2 w-2 rounded-full"
                        style={{
                          backgroundColor: PLAN_COLORS[entry.plan] || "#94a3b8",
                        }}
                      />
