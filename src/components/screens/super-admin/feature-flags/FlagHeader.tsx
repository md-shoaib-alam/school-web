...
export function FlagHeader({ onAddFlag }: FlagHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100 flex items-center gap-3">
          <div className="size-10 rounded-xl bg-teal-50 dark:bg-teal-900/30 flex items-center justify-center">
