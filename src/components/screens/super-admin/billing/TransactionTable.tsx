...
export function TransactionTable() {
  ...
  return (
    <Card className="shadow-sm border-none bg-white dark:bg-zinc-800 animate-in fade-in duration-500">
      <CardHeader className="pb-2 space-y-4 md:space-y-0 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-center bg-zinc-100 dark:bg-zinc-900 p-0.5 rounded-lg w-fit shrink-0">
      ...
      <CardContent>
            ...
            <TableBody>
              {loading ? (
                ...
                subscriptions.map((sub) => {
                  ...
                  return (
                    <TableRow key={sub.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-900/50 transition-colors h-14">
                      <TableCell>
        ...
        <div className="flex items-center justify-between px-2 py-4 border-t border-zinc-100 dark:border-zinc-700 mt-2">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="size-8 p-0 border-zinc-200 dark:border-zinc-700 shadow-none"
            >
