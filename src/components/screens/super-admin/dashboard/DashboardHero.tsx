...
export function DashboardHero({ loading, data }: DashboardHeroProps) {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-teal-950 via-teal-900 to-teal-800 p-6 lg:p-8 text-white shadow-lg">
      <div className="absolute top-0 right-0 size-80 bg-teal-700/20 rounded-full -translate-y-1/2 translate-x-1/4 blur-3xl" />
      <div className="absolute bottom-0 left-1/4 size-56 bg-teal-600/10 rounded-full translate-y-1/2 blur-2xl" />

      <div className="relative z-10">
        <div className="flex items-center gap-4 mb-8">
          <div className="size-14 rounded-2xl bg-white/10 flex items-center justify-center backdrop-blur-md border border-white/20 shadow-inner">
            <ShieldCheck className="size-7 text-teal-200" />
          </div>
          <div>
            ...
            <>
              <div className="bg-white/5 backdrop-blur-md rounded-2xl px-5 py-4 border border-white/10 hover:bg-white/10 transition-colors group">
                ...
                <p className="text-2xl font-black flex items-center gap-2">
                  <Building2 className="size-5 text-teal-400 group-hover:scale-110 transition-transform" />
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-2xl px-5 py-4 border border-white/10 hover:bg-white/10 transition-colors group">
                ...
                <p className="text-2xl font-black flex items-center gap-2">
                  <Users className="size-5 text-teal-400 group-hover:scale-110 transition-transform" />
                  {data?.users.total ?? 0}
                </p>
              </div>
              <div className="bg-white/5 backdrop-blur-md rounded-2xl px-5 py-4 border border-white/10 hover:bg-white/10 transition-colors group">
                ...
                <p className="text-2xl font-black flex items-center gap-1">
                  <IndianRupee className="size-5 text-teal-400 group-hover:scale-110 transition-transform" />
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-2xl px-5 py-4 border border-white/10 hover:bg-white/10 transition-colors group">
                ...
                <p className="text-2xl font-black flex items-center gap-2">
                  <CreditCard className="size-5 text-teal-400 group-hover:scale-110 transition-transform" />
