...
const STAT_CARDS = [
  ...
  },
  {
    ...
    iconBg: "bg-violet-200 text-violet-700 dark:text-violet-400",
  ...
  },
  {
    ...
    iconBg: "bg-blue-200 text-blue-700 dark:text-blue-400",
  ...
  },
  {
    ...
    iconBg: "bg-amber-200 text-amber-700 dark:text-amber-400",
  ...
  },
  {
    ...
    iconBg: "bg-emerald-200 text-emerald-700 dark:text-emerald-400",
...
export function SuperAdminUsers() {
  ...
  const getCount = (key: string) => {
    ...
    if (key === "admin") {
      return (
        (roleCountsMap["admin"] ?? 0) + (roleCountsMap["super_admin"] ?? 0)
      );
    }
  ...
  const setRoleFilterAndReset = (v: string) => {
    setRoleFilter(v);
    setCurrentPage(1);
  };
  const setTenantFilterAndReset = (v: string) => {
    setTenantFilter(v);
    setCurrentPage(1);
  };
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span
                    className={`text-xs font-medium ${stat.color} opacity-80`}
                  >
                    {percentage}%
                  </span>
                </div>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col lg:flex-row gap-3 items-start lg:items-center">
            ...
            <div className="flex items-center gap-2 w-full lg:w-auto">
              ...
              <Select
                value={tenantFilter}
                onValueChange={setTenantFilterAndReset}
              >
            ...
            <>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <span
                      className={`h-2 w-2 rounded-full ${selectedUser.isActive ? "bg-green-500" : "bg-red-500"}`}
                    />
                    {selectedUser.isActive
                      ? "Active Account"
                      : "Inactive Account"}
                ...
                {selectedUser.tenant ? (
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                            {selectedUser.tenant.plan ? (
                              selectedUser.tenant.plan.charAt(0).toUpperCase() +
                              selectedUser.tenant.plan.slice(1)
                            ) : (
                          ...
                          <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                            {selectedUser.tenant.status ? (
                              selectedUser.tenant.status
                                .charAt(0)
                                .toUpperCase() +
                              selectedUser.tenant.status.slice(1)
                            ) : (
                              <span className="text-muted-foreground">N/A</span>
                            )}
                          </p>
                  ...
                  <div className="rounded-lg border border-dashed p-4 text-center text-muted-foreground">
                    <p className="text-sm">
                      This user has no tenant association (Platform-level
                      account)
                    </p>
                  </div>
                )}
