...
const priorityConfig: Record<string, { bg: string; label: string }> = {
  urgent: { bg: 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 dark:text-red-400 border-red-200 dark:border-red-800', label: 'Urgent' },
  ...
  normal: { bg: 'bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-400 border-violet-200 dark:border-violet-800', label: 'Normal' },
