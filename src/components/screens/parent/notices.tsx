  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">School Notices</h2>
      </div>
      ...
      {filtered.length === 0 ? (
        ...
        <div className="space-y-4">
          {filtered.map((notice) => {
            ...
            const roleLabel = roleLabels[notice.targetRole] || notice.targetRole;
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <Badge variant="outline" className={`text-[10px] font-medium ${priority.bg}`}>
                          {priority.icon}
                      ...
                      <div className="flex flex-wrap items-center gap-4 mt-3 text-xs text-muted-foreground">
                        <span>By <span className="font-medium text-gray-600 dark:text-gray-400">{notice.authorName}</span></span>
                        <span>
