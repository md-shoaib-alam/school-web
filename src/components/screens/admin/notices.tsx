...
import { Megaphone, Plus, Search, Calendar, User, Pencil, Trash2, Eye } from 'lucide-react';
...
const priorityConfig: Record<string, { bg: string; text: string; border: string }> = {
  normal: { bg: 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300', text: 'Normal', border: 'border-l-gray-400 dark:border-l-gray-500' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        {canCreate && (
        <Button className="bg-emerald-600 hover:bg-emerald-700 text-white shrink-0" onClick={() => { setForm({ ...emptyForm }); setCreateOpen(true); }}>
        ...
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="grid gap-4 py-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                <Label>Target Audience</Label>
                <Select value={editForm.targetRole} onValueChange={(v) => setEditForm({ ...editForm, targetRole: v })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
