...
export const CBSEStandard: React.FC<MarksheetTemplateProps> = ({
  ...
  return (
    <div 
      className="relative bg-white text-zinc-900 px-9 py-8 border-[5px] border-emerald-800 rounded overflow-hidden select-none flex flex-col justify-between shrink-0 text-left h-[1000px] w-[794px] box-border font-sans"
