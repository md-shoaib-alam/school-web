...
export const ICSESemester: React.FC<MarksheetTemplateProps> = ({
  ...
  return (
    <div 
      className="relative bg-white text-[#1e293b] p-10 border-[6px] border-double border-violet-900 rounded overflow-hidden select-none flex flex-col justify-between shrink-0 text-left h-[1000px] w-[794px] box-border font-serif"
