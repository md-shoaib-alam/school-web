...
const AdminDashboard = dynamic(
  () =>
    import("@/components/screens/admin/dashboard").then(
      (m) => m.AdminDashboard,
    ),
...
const SuperAdminDashboard = dynamic(
  () =>
    import("@/components/screens/super-admin/dashboard").then(
      (m) => m.SuperAdminDashboard,
    ),
  { loading: LoadingScreen },
);
const SuperAdminTenants = dynamic(
  () =>
...
const SuperAdminBilling = dynamic(
  () =>
    import("@/components/screens/super-admin/billing").then(
      (m) => m.SuperAdminBilling,
    ),
  { loading: LoadingScreen },
);
const SuperAdminUsers = dynamic(
  () =>
    import("@/components/screens/super-admin/users").then(
      (m) => m.SuperAdminUsers,
    ),
  { loading: LoadingScreen },
);
const SuperAdminAuditLogs = dynamic(
  () =>
    import("@/components/screens/super-admin/audit-logs").then(
      (m) => m.SuperAdminAuditLogs,
    ),
  { loading: LoadingScreen },
);
const SuperAdminAnalytics = dynamic(
  () =>
    import("@/components/screens/super-admin/analytics").then(
      (m) => m.SuperAdminAnalytics,
    ),
  { loading: LoadingScreen },
);
const SuperAdminFeatureFlags = dynamic(
  () =>
    import("@/components/screens/super-admin/feature-flags").then(
      (m) => m.SuperAdminFeatureFlags,
    ),
  { loading: LoadingScreen },
);
const SuperAdminSettings = dynamic(
  () =>
    import("@/components/screens/super-admin/settings").then(
      (m) => m.SuperAdminSettings,
    ),
  { loading: LoadingScreen },
);
const SuperAdminRoles = dynamic(
  () =>
    import("@/components/screens/super-admin/roles").then(
      (m) => m.SuperAdminRoles,
    ),
  { loading: LoadingScreen },
);
const SuperAdminManage = dynamic(
  () =>
    import("@/components/screens/super-admin/manage-admins").then(
      (m) => m.SuperAdminManage,
    ),
  { loading: LoadingScreen },
);
const SuperAdminStaff = dynamic(
  () =>
    import("@/components/screens/super-admin/staff").then(
      (m) => m.SuperAdminStaff,
    ),
  { loading: LoadingScreen },
);
const SuperAdminSubscriptions = dynamic(
  () =>
    import("@/components/screens/super-admin/subscriptions").then(
      (m) => m.SuperAdminSubscriptions,
    ),
  { loading: LoadingScreen },
);
const SuperAdminSchoolSubscriptions = dynamic(
  () =>
    import("@/components/screens/super-admin/school-subscriptions").then(
      (m) => m.SuperAdminSchoolSubscriptions,
    ),
  { loading: LoadingScreen },
);
...
const StudentDashboard = dynamic(
  () =>
    import("@/components/screens/student/dashboard").then(
...
const ParentDashboard = dynamic(
  () =>
    import("@/components/screens/parent/dashboard").then(
      (m) => m.ParentDashboard,
    ),
  { loading: LoadingScreen },
);
const StaffDashboard = dynamic(
  () =>
    import("@/components/screens/staff/dashboard").then(
      (m) => m.StaffDashboard,
    ),
  { loading: LoadingScreen },
);
const NotFoundScreen = dynamic(() =>
  import("@/components/screens/error/not-found").then((m) => m.NotFoundScreen),
);
